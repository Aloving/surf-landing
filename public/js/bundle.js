...
var _facade__modals = require('./modals/__facade__modals');
...
_appMediator.mediator.subscribe(modalsLifeCycle.callModal, _facade__modals.modalsFacade.implementModal(_appMediator.mediator.publish.bind(undefined, modalsLifeCycle.readyModal)));

_appMediator.mediator.subscribe(modalsLifeCycle.readyModal, function (modal) {
...
},{"./__facade__app":1,"./app-mediator":2,"./buyModule/__facade__buymodule":4,"./modals/__facade__modals":24,"babelify-es6-polyfill":191,"whatwg-fetch":198}],4:[function(require,module,exports){
'use strict';
...
},{"fs":194,"pug-runtime":196}],23:[function(require,module,exports){
'use strict';
...
var _implementModal = require('./implementModal');
...
module.exports = {
	implementModal: _implementModal.implementModal,
...
},{"./_createModal":25,"./_fetchContent":26,"./_templateContent":28,"./implementModal":29}],25:[function(require,module,exports){
'use strict';
...
function fetchContent(publishcb, errcb) {
	return function () {
		_facade__fetchMap.fetchMap.getModalContent(publishcb, errcb)((0, _app._gettingUrl)('aboutVideo'));
	};
}
...
},{"../modules/mediatorCreate":33}],28:[function(require,module,exports){
'use strict';
...
_modalsMediator.mediator.subscribe(lifeCycle.publishDOMcontent, function (data) {
...
function implementModal(publishModal) {
	_modalsMediator.mediator.subscribe(lifeCycle.implementedModal, publishModal);
	return function (info) {
		_modalsMediator.mediator.publish(lifeCycle.startCycle, info);
	};
}

},{"../modules/cacheStorage":31,"./__facade__modals":24,"./_modalsMediator":27}],30:[function(require,module,exports){
'use strict';
...
},{"./shim.js":192,"regenerator/runtime":197}],192:[function(require,module,exports){
...
},{"fs":193}],197:[function(require,module,exports){
...
},{"_process":195}],198:[function(require,module,exports){
(function(self) {
  'use strict';
